...
export const en: Record<keyof typeof es, string> = {
  ...
  "auth.mfaTitle": "Authenticator code",
  "auth.mfaHint":
    "Open your authenticator app and type the 6 digits for Distop. Lost your phone? Type one of your backup codes.",
  "auth.mfaCode": "Code",
  "auth.mfaBack": "Back to password",

  "start.title": "What do you want to do?",
  "start.createUser": "Create a user",
  "start.createUserHint": "Pick a name and start joining communities.",
  "start.admin": "Sign in as admin of my server",
  "start.adminHint": "Your VPS or your PC, using its Tailscale address.",
  "start.address": "Your server address",
  "start.addressHint": "Starts with https://, for example https://my-vps.your-net.ts.net",
  "start.addressInvalid": "The address must start with https://",
  "start.notInstance": "There is no Distop server at that address.",
  "start.connect": "Connect",
  "start.back": "Back",

  "security.title": "Admin security",
  "security.hintOff":
    "Protect admin sign-in from outside: besides the password, a code from your phone is asked the first time on each device.",
  "security.on": "Authenticator on · {n} backup codes",
  "security.enable": "Turn on authenticator",
  "security.reconfigure": "Set up another phone",
  "security.newCodes": "New backup codes",
  "security.step1": "1. Install an authenticator app",
  "security.step1Hint": "Scan this QR with your phone camera: it opens Google Authenticator on the Play Store.",
  "security.android": "Google Authenticator for Android",
  "security.iphone": "Google Authenticator for iPhone",
  "security.step2": "2. Scan the Distop code",
  "security.step2Hint": "In the app tap “+” and then “Scan a QR code”. If you can't scan, type this key:",
  "security.step3": "3. Type the code the app shows",
  "security.confirm": "Confirm",
  "security.codesTitle": "Save your backup codes",
  "security.codesHint": "Each one works once if you lose your phone. They won't be shown again.",
  "security.copy": "Copy",
  "security.copied": "Copied",
  "security.saved": "I saved them",
  "security.currentCode": "Current app code",
  "security.lostAll": "If you lose your phone and the codes, run this on the VPS: sudo distop-admin-recovery",
  ...
  "serverUsage.title": "Usage and configuration",
  "serverUsage.hint": "What this machine uses and a projection based on the last seven days.",
  "serverUsage.profile": "Server type",
  "serverUsage.profileHint": "An explicit choice: it is not guessed from a domain or tunnel.",
  "serverUsage.personalPc": "Personal PC or home server",
  "serverUsage.vpsCloud": "VPS or cloud",
  "serverUsage.images": "Photos",
  "serverUsage.videos": "Videos",
  "serverUsage.audio": "Audio",
  "serverUsage.files": "Other files",
  "serverUsage.traffic7d": "7-day traffic",
  "serverUsage.projection": "30-day projection",
  "serverUsage.stack": "Stack",
  "serverUsage.risk": "The projection exceeds free space. Consider moving videos or files to P2P or turning them off.",
  "serverUsage.ok": "The current projection fits in free space.",
  ...
  "explore.join": "Join",
  "notice.unread": "{count} unread",
  "notice.title": "Notices",
  "notice.empty": "Nothing to tell you yet",
  "notice.emptyHint": "Messages, people joining your communities, and whatever happens to your server while you were not looking all end up here.",
  "notice.go": "Go",
  "notice.clear": "Clear",
  "notice.offlineTitle": "Connection lost",
  "notice.offlineBody": "Your server cannot be reached. Anything you write now waits until it is back.",
  "notice.onlineTitle": "Server is back",
  "notice.onlineBody": "The connection has been restored.",
  "notice.memberTitle": "Someone new",
  "notice.memberBody": "{name} joined {community}.",
  "explore.openMine": "Open",
  ...
  "message.audioProcessing": "Preparing audio…",
  "message.audioCancel": "Cancel recording",
  "message.audioStop": "Stop recording",
  "message.audioUnsupported": "This browser cannot record voice messages.",
  "message.audioSecure": "The microphone only works over HTTPS or on localhost.",
  "message.audioDenied": "Microphone permission was denied. Allow it in the browser's site controls and try again.",
  "message.audioNoMic": "No microphone was found.",
  "message.audioFailed": "The audio could not be recorded. Check your microphone and try again.",
  "message.audioEmpty": "The recording was empty. Try again.",
  ...
  "voice.full":
    "This room is full. Without a relay server, every voice is copied once per listener, so the host caps how many fit at a time rather than letting everyone break up. Join as soon as someone leaves.",
  "voice.camera": "Camera",
  ...
  "settings.bannerTune": "Adjust banner",
  "settings.bannerTuneHint": "Move the focal point to choose which part of the image is visible.",
  "settings.bannerPreview": "Banner framing preview",
  "settings.bannerPositionX": "Horizontal position",
  "settings.bannerPositionY": "Vertical position",
...
"common.saving": "Saving…",
  ...
  "message.audioPlay": "Play",
  "message.audioPause": "Pause",
  "message.audioSeek": "Jump to a point in the audio",

  "voice.cameraDevice": "Camera",
  "voice.cameraHint": "The one that turns on when you enable video in a call.",
  "voice.cameraPick": "Choose camera",
  "voice.cameraUnnamed": "Camera {n}",

  "share.communities": "Communities in the directory",
  "share.communitiesHint":
    "Which of your communities show up in the public directory. Name, icon and description are published; nothing that happens inside.",
  "share.status.private": "Private",
  "share.status.unlisted": "Unlisted",
  "share.status.needsStable": "Needs a stable address",
  "share.status.live": "Listed",
  ...
  "explore.soon": "Soon",
  "explore.heroTitle": "Explore communities",
  "explore.categories": "Categories",
  "explore.category.home": "All",
  "explore.category.games": "Games",
  "explore.category.music": "Music",
  "explore.category.entertainment": "Entertainment",
  "explore.category.science": "Science & tech",
  "explore.category.education": "Education",
  "explore.category.students": "Students",
  "explore.category.other": "Other",
  "community.category": "Category",
  "community.categoryHint": "What it is about. This is what the public directory filters by, so it is not guessed from the name. You can change it whenever you like.",
  "explore.featured": "Featured",
  "explore.results": "{count} communities",
  "explore.pages": "Community pages",
  "explore.pagePrev": "Previous",
  "explore.pageNext": "Next",
  "explore.pageOf": "Page {page} of {pages}",
  "explore.checkingOnline": "Checking which servers are online…",
  "explore.pageOffline": "No community on this page is online right now",
  "explore.search": "Search communities",
  "explore.noResults": "Nothing here",
  "explore.noResultsHint": "Try other words, or switch category.",
  "explore.noDescription": "No description.",
  "explore.membersShort": "members",
  "explore.publicCommunity": "Public community",
  "explore.openAccess": "Open to anyone",
  "explore.approvalRequired": "Approval required",
  "explore.partialFailure":
    "A server didn't answer, so some communities may be missing from the list.",

  "direct.title": "Messages",
  "direct.searchOrStart": "Find someone or start a conversation",
  "direct.friends": "Friends",
  "direct.friendRequests": "Friend requests",
  "direct.messageRequests": "Message requests",
  "direct.new": "New conversation",
  "direct.empty": "You're not talking to anyone yet",
  "direct.emptyHint": "Look someone up by username and start whenever you like.",
  "direct.start": "Start a conversation",
  "direct.attachment": "Attachment",
  "direct.awaitingApproval": "Waiting for them to accept",
  "direct.search": "Search people",
  "direct.searchPlaceholder": "Name or @username",
  "direct.noContacts": "Nobody by that name",
  "direct.message": "Send message",
  "direct.profileAction": "Send message",
  "direct.alreadyFriends": "Already friends",
  "direct.requestSent": "Request sent",
  "direct.acceptFriend": "Accept request",
  "direct.addFriend": "Add friend",
  "direct.noFriends": "No friends yet",
  "direct.noFriendsHint":
    "Add someone and they'll be one click away instead of a search away.",
  "direct.allFriends": "All friends — {count}",
  "direct.removeFriend": "Remove friend",
  "direct.removeFriendConfirm": "Remove {name} from your friends?",
  "direct.receivedRequests": "Received",
  "direct.noFriendRequests": "No pending requests.",
  "direct.accept": "Accept",
  "direct.reject": "Decline",
  "direct.sentRequests": "Sent",
  "direct.noSentRequests": "You haven't sent any requests.",
  "direct.messageRequestsHint":
    "Messages from people who aren't your friends. Accepting opens the conversation; declining deletes it.",
  "direct.noMessageRequests": "No message requests",
  "direct.noMessageRequestsHint":
    "This is where people who aren't your friends land when they write to you.",
  "direct.wantsToMessage": "Wants to message you",
  "direct.wantsToMessageNamed": "{name} wants to message you.",
  "direct.acceptAndReply": "Accept and reply",
  "direct.noSelection": "Pick a conversation",
  "direct.noSelectionHint": "Or start a new one from the button above.",
  "direct.loadMore": "See earlier messages",
  "direct.noMessages": "Nothing here yet",
  "direct.noMessagesHint": "Write the first line and {name} will see it on arrival.",
  "direct.you": "You",
  "direct.edited": "edited",
  "direct.reply": "Reply",
  "direct.edit": "Edit",
  "direct.replyingTo": "Replying to",
  "direct.awaitingMessageApproval":
    "{name} hasn't accepted the conversation yet.",
  "direct.fileTooLarge": "That file is over {size} MB.",
  "direct.attach": "Attach file",
  "direct.placeholder": "Message {name}",
  "direct.send": "Send",
  "direct.deleteConfirm": "Delete this message?",
};
