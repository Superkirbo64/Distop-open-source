...
export const en: Record<keyof typeof es, string> = {
  ...
  "auth.mfaHint":
    "Open Google Authenticator and type the 6 digits for Distop. Lost your phone? Get a recovery code on the VPS with sudo distop-admin-recovery.",
  "auth.mfaCode": "Code",
  ...
  "security.lostAll": "If you lose your phone, run this on the VPS: sudo distop-admin-recovery",
