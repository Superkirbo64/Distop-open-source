...
export const es = {
  ...
  "auth.mfaTitle": "Código del autenticador",
  "auth.mfaHint":
    "Abre tu app autenticadora y escribe los 6 dígitos de Distop. Si perdiste el teléfono, escribe uno de tus códigos de respaldo.",
  "auth.mfaCode": "Código",
  "auth.mfaBack": "Volver a la contraseña",

  "start.title": "¿Qué quieres hacer?",
  "start.createUser": "Crear usuario",
  "start.createUserHint": "Pon tu nombre y entra a participar en comunidades.",
  "start.admin": "Entrar como admin de mi servidor",
  "start.adminHint": "Tu VPS o tu PC, por su dirección de Tailscale.",
  "start.address": "Dirección de tu servidor",
  "start.addressHint": "Empieza por https://, por ejemplo https://mi-vps.tu-red.ts.net",
  "start.addressInvalid": "La dirección tiene que empezar por https://",
  "start.notInstance": "En esa dirección no hay un servidor de Distop.",
  "start.connect": "Conectar",
  "start.back": "Volver",

  "security.title": "Seguridad del admin",
  "security.hintOff":
    "Protege la entrada como admin desde fuera: además de la contraseña, se pedirá un código de tu teléfono la primera vez en cada dispositivo.",
  "security.on": "Autenticador activado · {n} códigos de respaldo",
  "security.enable": "Activar autenticador",
  "security.reconfigure": "Configurar otro teléfono",
  "security.newCodes": "Códigos de respaldo nuevos",
  "security.step1": "1. Instala una app autenticadora",
  "security.step1Hint": "Escanea este QR con la cámara del teléfono: abre Google Authenticator en la Play Store.",
  "security.android": "Google Authenticator para Android",
  "security.iphone": "Google Authenticator para iPhone",
  "security.step2": "2. Escanea el código de Distop",
  "security.step2Hint": "En la app pulsa «+» y luego «Escanear un código QR». Si no puedes escanear, escribe esta clave:",
  "security.step3": "3. Escribe el código que muestra la app",
  "security.confirm": "Confirmar",
  "security.codesTitle": "Guarda tus códigos de respaldo",
  "security.codesHint": "Cada uno sirve una sola vez si pierdes el teléfono. No se vuelven a mostrar.",
  "security.copy": "Copiar",
  "security.copied": "Copiados",
  "security.saved": "Ya los guardé",
  "security.currentCode": "Código actual de la app",
  "security.lostAll": "Si pierdes el teléfono y los códigos, en la VPS ejecuta: sudo distop-admin-recovery",
  ...
  "serverUsage.title": "Consumo y configuración",
  "serverUsage.hint": "Lo que usa esta máquina y una proyección basada en los últimos siete días.",
  "serverUsage.profile": "Tipo de servidor",
  "serverUsage.profileHint": "Decisión explícita: no se adivina por tener un dominio o un túnel.",
  "serverUsage.personalPc": "PC personal o servidor de casa",
  "serverUsage.vpsCloud": "VPS o nube",
  "serverUsage.images": "Fotos",
  "serverUsage.videos": "Vídeos",
  "serverUsage.audio": "Audios",
  "serverUsage.files": "Otros archivos",
  "serverUsage.traffic7d": "Tráfico de 7 días",
  "serverUsage.projection": "Proyección a 30 días",
  "serverUsage.stack": "Stack",
  "serverUsage.risk": "La proyección supera el espacio libre. Conviene pasar vídeos o archivos a P2P o apagarlos.",
  "serverUsage.ok": "La proyección actual cabe en el espacio libre.",
  ...
  "explore.join": "Entrar",
  "notice.unread": "{count} sin leer",
  "notice.title": "Avisos",
  "notice.empty": "Nada que contarte todavía",
  "notice.emptyHint": "Aquí quedan los mensajes, las entradas a tus comunidades y lo que le pase a tu servidor mientras no estabas mirando.",
  "notice.go": "Ir",
  "notice.clear": "Vaciar",
  "notice.offlineTitle": "Se perdió la conexión",
  "notice.offlineBody": "No se llega a tu servidor. Lo que escribas ahora no saldrá hasta que vuelva.",
  "notice.onlineTitle": "Servidor de vuelta",
  "notice.onlineBody": "La conexión se ha restablecido.",
  "notice.memberTitle": "Alguien nuevo",
  "notice.memberBody": "{name} entró en {community}.",
  ...
  "community.publicIndexOff": "Esta instancia todavía no se anuncia en el índice público: enciéndelo en «Tu servidor» y la comunidad aparecerá en Explorar. Mientras tanto, marcarla como pública solo la hace visible aquí dentro.",
  ...
  "message.audioProcessing": "Preparando el audio…",
  "message.audioCancel": "Cancelar grabación",
  "message.audioStop": "Detener grabación",
  "message.audioUnsupported": "Este navegador no permite grabar mensajes de audio.",
  "message.audioSecure": "El micrófono solo funciona desde HTTPS o localhost.",
  "message.audioDenied": "No diste permiso al micrófono. Actívalo en el candado del navegador e inténtalo otra vez.",
  "message.audioNoMic": "No se encontró ningún micrófono.",
  "message.audioFailed": "No se pudo grabar el audio. Comprueba el micrófono e inténtalo otra vez.",
  "message.audioEmpty": "La grabación quedó vacía. Inténtalo otra vez.",
  ...
  "voice.full":
    "Esta sala está llena. Sin un servidor que reparta, cada voz se copia una vez por oyente, así que quien hospeda limita cuánta gente cabe a la vez en lugar de que se entrecorte para todos. Entra en cuanto salga alguien.",
  "voice.camera": "Cámara",
  ...
  "settings.bannerTune": "Ajustar el banner",
  "settings.bannerTuneHint": "Mueve el punto de enfoque para elegir qué parte de la imagen se ve.",
  "settings.bannerPreview": "Vista previa del encuadre del banner",
  "settings.bannerPositionX": "Posición horizontal",
  "settings.bannerPositionY": "Posición vertical",
  "settings.theme": "Tema",
...
"common.saving": "Guardando…",
  ...
  "message.audioPlay": "Reproducir",
  "message.audioPause": "Pausar",
  "message.audioSeek": "Ir a un punto del audio",

  "voice.cameraDevice": "Cámara",
  "voice.cameraHint": "La que se enciende al activar el vídeo en una llamada.",
  "voice.cameraPick": "Elegir cámara",
  "voice.cameraUnnamed": "Cámara {n}",

  "share.communities": "Comunidades en el índice",
  "share.communitiesHint":
    "Cuáles de tus comunidades salen en el directorio público. Se publica el nombre, el icono y la descripción; nada de lo que pasa dentro.",
  "share.status.private": "Privada",
  "share.status.unlisted": "Sin listar",
  "share.status.needsStable": "Necesita una dirección estable",
  "share.status.live": "En el índice",

  "explore.discover": "Descubrir",
  "explore.servers": "Servidores",
  "explore.applications": "Aplicaciones",
  "explore.missions": "Misiones",
  "explore.soon": "Pronto",
  "explore.heroTitle": "Explora comunidades",
  "explore.categories": "Categorías",
  "explore.category.home": "Todas",
  "explore.category.games": "Juegos",
  "explore.category.music": "Música",
  "explore.category.entertainment": "Entretenimiento",
  "explore.category.science": "Ciencia y tecnología",
  "explore.category.education": "Enseñanza",
  "explore.category.students": "Estudiantes",
  "explore.category.other": "Otras",
  "community.category": "Categoría",
  "community.categoryHint": "De qué va. Es lo que filtra el directorio público, así que no se adivina por el nombre. Se puede cambiar cuando quieras.",
  "explore.featured": "Destacadas",
  "explore.results": "{count} comunidades",
  "explore.pages": "Páginas de comunidades",
  "explore.pagePrev": "Anterior",
  "explore.pageNext": "Siguiente",
  "explore.pageOf": "Página {page} de {pages}",
  "explore.checkingOnline": "Comprobando qué servidores están en línea…",
  "explore.pageOffline": "Ninguna comunidad de esta página está en línea ahora",
  "explore.search": "Buscar comunidades",
  "explore.noResults": "Nada por aquí",
  "explore.noResultsHint": "Prueba con otras palabras o cambia de categoría.",
  "explore.noDescription": "Sin descripción.",
  "explore.membersShort": "miembros",
  "explore.publicCommunity": "Comunidad pública",
  "explore.openAccess": "Entrada libre",
  "explore.approvalRequired": "Hay que pedir entrar",
  "explore.partialFailure":
    "Algún servidor no contestó, así que puede que falten comunidades en la lista.",

  "direct.title": "Mensajes",
  "direct.searchOrStart": "Buscar o empezar una conversación",
  "direct.friends": "Amigos",
  "direct.friendRequests": "Solicitudes de amistad",
  "direct.messageRequests": "Solicitudes de mensaje",
  "direct.new": "Nueva conversación",
  "direct.empty": "Todavía no hablas con nadie",
  "direct.emptyHint":
    "Busca a alguien por su nombre de usuario y empieza cuando quieras.",
  "direct.start": "Empezar una conversación",
  "direct.attachment": "Archivo adjunto",
  "direct.awaitingApproval": "Esperando a que acepte",
  "direct.search": "Buscar personas",
  "direct.searchPlaceholder": "Nombre o @usuario",
  "direct.noContacts": "Nadie con ese nombre",
  "direct.message": "Enviar mensaje",
  "direct.profileAction": "Enviar mensaje",
  "direct.alreadyFriends": "Ya sois amigos",
  "direct.requestSent": "Solicitud enviada",
  "direct.acceptFriend": "Aceptar solicitud",
  "direct.addFriend": "Añadir amigo",
  "direct.noFriends": "Aún no tienes amigos",
  "direct.noFriendsHint":
    "Añade a alguien y lo tendrás a mano sin buscarlo cada vez.",
  "direct.allFriends": "Todos los amigos — {count}",
  "direct.removeFriend": "Quitar de amigos",
  "direct.removeFriendConfirm": "¿Quitar a {name} de tus amigos?",
  "direct.receivedRequests": "Recibidas",
  "direct.noFriendRequests": "No tienes solicitudes pendientes.",
  "direct.accept": "Aceptar",
  "direct.reject": "Rechazar",
  "direct.sentRequests": "Enviadas",
  "direct.noSentRequests": "No has enviado ninguna solicitud.",
  "direct.messageRequestsHint":
    "Mensajes de gente que no tienes como amiga. Aceptar abre la conversación; rechazar la borra.",
  "direct.noMessageRequests": "No hay solicitudes de mensaje",
  "direct.noMessageRequestsHint":
    "Aquí llega quien te escribe sin ser amigo tuyo.",
  "direct.wantsToMessage": "Quiere escribirte",
  "direct.wantsToMessageNamed": "{name} quiere escribirte.",
  "direct.acceptAndReply": "Aceptar y responder",
  "direct.noSelection": "Elige una conversación",
  "direct.noSelectionHint": "O empieza una nueva desde el botón de arriba.",
  "direct.loadMore": "Ver mensajes anteriores",
  "direct.noMessages": "Aquí no hay nada todavía",
  "direct.noMessagesHint": "Escribe lo primero y {name} lo verá al entrar.",
  "direct.you": "Tú",
  "direct.edited": "editado",
  "direct.reply": "Responder",
  "direct.edit": "Editar",
  "direct.replyingTo": "Respondiendo a",
  "direct.awaitingMessageApproval":
    "{name} todavía no ha aceptado la conversación.",
  "direct.fileTooLarge": "El archivo pasa de {size} MB.",
  "direct.attach": "Adjuntar archivo",
  "direct.placeholder": "Escribe a {name}",
  "direct.send": "Enviar",
  "direct.deleteConfirm": "¿Eliminar este mensaje?",
} as const;
