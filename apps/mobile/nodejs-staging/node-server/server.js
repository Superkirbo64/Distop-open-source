...
import { countOwners, pruneSessions } from "./auth.js";
...
const WEB_DIST = process.env.WEB_DIST_PATH ? resolve(process.env.WEB_DIST_PATH) : resolve(__distopDirname(new URL(".", import.meta.url)), "..", "web", "dist");
...
export const server = createServer((req, res) => {
    ...
    if (!isApi && (req.method === "GET" || req.method === "HEAD") && serveStatic(req, res))
        return;
