...
const es = {
  ...
  footer: {
    ...
    legal: "Software libre bajo AGPL-3.0. Proyecto independiente, hecho para comunidades y no para accionistas.",
    langLabel: "Idioma",
  },
  install: {
...
const en: Dict = {
  ...
  footer: {
    ...
    legal: "Free software under AGPL-3.0. An independent project, built for communities and not for shareholders.",
    langLabel: "Language",
  },
  install: {
...
const ptBR: Dict = {
  ...
  footer: {
    ...
    legal: "Software livre sob AGPL-3.0. Projeto independente, feito para comunidades e não para acionistas.",
    langLabel: "Idioma",
  },
  install: {
