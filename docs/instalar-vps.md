...
```sh
curl -fLO https://github.com/Superkirbo64/Distop-open-source/releases/download/v0.1.4/install-vps.sh
curl -fLO https://github.com/Superkirbo64/Distop-open-source/releases/download/v0.1.4/install-vps.sh.sha256
...
```sh
sudo bash install-vps.sh --version 0.1.4
```
